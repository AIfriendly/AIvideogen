...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*complete-story" workflow="{project-root}/.bmad/bmm/workflows/4-implementation/complete-story/workflow.yaml">Full story lifecycle: create → review → implement → test → push</item>
    ...
    <item cmd="*story-done" workflow="{project-root}/.bmad/bmm/workflows/4-implementation/story-done/workflow.yaml">Mark story as done and advance the queue</item>
    ...
    <item cmd="*code-review" workflow="{project-root}/.bmad/bmm/workflows/4-implementation/code-review/workflow.yaml">Senior Developer code review on completed story</item>
