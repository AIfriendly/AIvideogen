...
export interface SceneAnalysis {
  ...
  /**
   * Extracted named entities (e.g., "Ornstein and Smough", "Dark Souls", "Winter Palace")
   * Specific subjects, game titles, historical events, or concepts extracted from scene text
   * Added in Story 3.2b for enhanced query generation
   */
  entities?: string[];

  /**
   * Enhanced query with negative terms and B-roll indicators applied
   * Format: "{primary query} {b-roll terms} {-negative terms}"
   * Generated by post-processing the primary query based on content type
   * Added in Story 3.2b for pure B-roll results
   */
  enhancedQuery?: string;

  /**
   * Expected Vision API labels for content verification (Story 3.7)
   * Labels that should appear in video frames to verify content relevance
   * Generated by LLM based on scene content
   */
